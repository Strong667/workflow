...
const messages: MessageSchema = {
  ...
  employees: {
    ...
    accessCreateHint: 'The email above becomes the login. Share the password — the person can sign in right away.',
    accessEditHint: 'The login is the email from the card. The password changes only if you fill the field.',
